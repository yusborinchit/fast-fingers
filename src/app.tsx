      ...
      <main className="max-w-screen-sm px-4 pt-10 mx-auto">
        <section className="flex flex-col gap-4">
          <article className="flex flex-col gap-1">
            <header className="flex gap-2 text-xs">
              ...
              <p className="ml-auto text-green-500">
                <span className="font-bold">Correct Words:</span> {correct}
              </p>
              <p className="text-red-500">
                <span className="font-bold">Incorrect Words:</span> {incorrect}
              </p>
            </header>
            <div className="p-4 border rounded border-zinc-500">
              <p
                ref={paragraphRef}
                className="flex flex-wrap gap-x-1 gap-y-2 text-lg h-[144px] text-zinc-500 overflow-hidden"
              >
          ...
          <input
            ...
            value={inputWord}
            className="flex-1 px-4 py-2 rounded border-zinc-500 text-zinc-900"
          />
        </section>
      </main>
    </>
